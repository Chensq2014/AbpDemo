...
namespace DataProcessor.Web.Menus;

public class DataProcessorMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public DataProcessorMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<DataProcessorResource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                DataProcessorMenus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fas fa-home",
                order: 0
